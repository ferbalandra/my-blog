...
<?php
    ...
    $to = "ferbalandra@gmail.com"; // Replace xxxx@xxxx.com with your email address (mandatory!) 
    $subject = "Hello"; // Choose a custom subject (not mandatory)

    $body = "You have received a message from " . $name . " (" . $email . "):\n\n" . $message;

    $from = "From: Fernanda Balandra"; // Replace "Beetle Template" with your site name (not mandatory)   
    $headers = "From:" . $from . "\r\n";
